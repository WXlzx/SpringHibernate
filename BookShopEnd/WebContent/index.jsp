				...
				<div class="col-md-4 col-sm-6" >
					<div class="single-product">
						<div class="single-product-image">
							<figure>
								<img src="${book.book_img }" alt="${book.book_name }" width="260px" height="300px"/>
							</figure>
						...
						<div class="single-product-hover-item">
							<div class="single-product-hover-item-inner-area">
								<ul>
									<li>
										<a href="addorder.do?uid=${user.id}&bid=${book.book_id }&count=1">
									...
									<li>
										<a href="xiangqing.do?bookid=${book.book_id }" >
...
<div class="popupbody">
	<div class="popup-product-image">
			<img src="${book.book_img }"  alt="product-popup-image">
	</div>
		...
		<div class="button-rating-area">
			...
			<div class="product-cart-area popup-cart-quantity">
				...
				<div class="cart-wishlist align-middle">
					<ul>
						<li class="nv-btn-type5">
							<a href="addorder.do?uid=${user.id}&bid=${book.book_id }&count=">
								Add to cart
							</a>
						</li>
					</ul>
