...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="w">
                <div class="span12">
              		<form action="<%=basePath %>/../adminupdatesubmit.do">
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                            <tr align="center">
                        		<th> <input type="text" name="name" value="${admin.name}"> </th>
                        		<th> <input type="text" name="password" value="${admin.password }"> </th>
                        		<th> <input type="submit" value="修改密码"></th>
                       		</tr> 
                        </tbody>
